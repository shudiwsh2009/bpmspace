...
public class TestTreeDefinition {
	...
	public static void main(String argv[]) throws java.io.IOException {
		...
		// A Tree
		Hashtable<String, ArrayList<String>> testTree = new Hashtable<String, ArrayList<String>>();

		// a-[b,c]
		ArrayList<String> aChildren = new ArrayList<String>();
		aChildren.add("b");
		aChildren.add("c");
		...
		// c-[d, e, f]
		ArrayList<String> cChildren = new ArrayList<String>();
		cChildren.add("d");
		cChildren.add("e");
		cChildren.add("f");
		...
		aBasicTree = new BasicTree(testTree, "a", BasicTree.POSTORDER);
