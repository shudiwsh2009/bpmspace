...
public interface TreeLayout {
	...
	/**
	 * Return a line that defines a particular height. Some layouts won't be
	 * able to produce this and may throw an UnsupportedOperationException.
	 *
	 * @param height
	 * @return the line
	 */
	 ...
	 * won't be able to produce this and may throw an
