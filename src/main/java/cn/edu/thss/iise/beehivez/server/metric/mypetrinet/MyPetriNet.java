...
public class MyPetriNet implements Cloneable {
	...
	/**
	 * Add any MyPetriNet Object All observers are notified of this change.
	 * 
	 * @param e
	 *            The MyPetriNet Object to be added.
	 */
	// ��ӳ�Ա
	...
	/**
	 * Removes the specified object from the appropriate vector of objects. All
	 * observers are notified of this change.
	 * 
	 * @param id
	 *            Id of the MyPetriNet Object to be removed.
	 */
	// ���idɾ���Ա
	 ...
	 * 
	 * @param index
	 *            The location of the MyPetriNet Object in the vector
	...
	/**
	 * 
	 * @return The vector contains all Transitions in the MyPetriNet Object
	 *         Vector
	 */
	// ��ȡ��Ǩ����
	...
	public void run() {
		...
		// ��Դ�����ǿ�ʼ�������}���
		/*
		 * if ( ( (MyPetriPlace) petri.get(getSourcePlace())).isempty()) {
		 * return; }
		 */
		// log case id
		caseid++;
	...
	public void adjustXORsplit(String transid) {
		...
		newarc = new MyPetriArc(transid + "_newoutplace", transid,
				newplace.getid());
		addObject(newarc);
		...
		for (int i = 0; i < petri.size(); i++) {
			...
			// ������ȴ���2�����
				...
				MyPetriTransition tt = new MyPetriTransition(placeid + "_route"
						+ count, "ROUTE", null);
				addObject(tt);
				MyPetriArc tr = new MyPetriArc(placeid + "_arc" + count,
						newplace.getid(), tt.getid());
				addObject(tr);
				//
				// MyPetriArc tr2=new
	...
	// System.out.println("p:" + placeNo + ";t:" + transitionNo + ";w:" +
	...
	// e=edges.get(i);
	// myPetri.addObject(new
	// MyPetriArc(e.getName(),e.getSource().getIdentifier(),e.getDest().getIdentifier()));
	// }
	// return myPetri;
	// }
	public static MyPetriNet fromProMPetriToMyPetri(PetriNet promPetri) {
		...
		for (int i = 0; i < edges.size(); i++) {
			e = edges.get(i);
			myPetri.addObject(new MyPetriArc(e.getName(), ""
					+ e.getSource().getIdKey(), "" + e.getDest().getIdKey()));
		}
		return myPetri;
	}
}
