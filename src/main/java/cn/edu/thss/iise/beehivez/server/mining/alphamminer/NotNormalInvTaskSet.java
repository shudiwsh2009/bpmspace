...
class NotNormalInvTask {
	...
	public NotNormalInvTask(int _a, int _b, int _x, int _y,
			ArrayList<Integer> _beforeCausal, ArrayList<Integer> _afterCausal,
			ArrayList<Integer> _sharpRelation) {
		a = _a;
		b = _b;
		x = _x;
		y = _y;
...
public class NotNormalInvTaskSet {
	HashMap<PredSucc, NotNormalInvTask> content;

	public NotNormalInvTaskSet() {
		content = new HashMap<PredSucc, NotNormalInvTask>();
	}

	public void addNotNormalInvTask(PredSucc ps, int a, int b, int x, int y,
			ArrayList<Integer> beforeCausal, ArrayList<Integer> afterCausal,
			ArrayList<Integer> sharpRelation) {
		NotNormalInvTask notNormalInvTask = new NotNormalInvTask(a, b, x, y,
				beforeCausal, afterCausal, sharpRelation);
