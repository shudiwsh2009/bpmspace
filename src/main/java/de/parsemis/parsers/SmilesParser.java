...
public class SmilesParser implements GraphParser<Atom, Bond> {
	 ...
	 * @param nodeVisited
	 *            an array where each visited atom has a <code>true</code> entry
	 *            at its index
	 * @param edgeVisited
	 *            an array where each visited edge has a <code>true</code> entry
	 *            at its index
	 * @param markers
	 ...
	 * 
	 * @see
	 * de.parsemis.parsers.GraphParser#serializeFragments(java.io.OutputStream,
	 * java.util.Collection)
	 */
