...
import cn.edu.thss.iise.xiaohan.abpcd.graph.Helper;
import cn.edu.thss.iise.xiaohan.abpcd.graph.TreeVisitorDB;
import cn.edu.thss.iise.xiaohan.abpcd.graph.Visitor;
...
public class RPSDag {
	...
	public void addProcessModel(Helper helper, String filename, DBSCAN scan)
			throws Exception {
		addProcessModel(helper, false, filename, scan);
	}

	public void addProcessModel(Helper helper, boolean print, String filename,
			DBSCAN scan) throws Exception {
		...
		scan.recordFragments(t, filename);
		// ---------------------------------------------------------------------------
