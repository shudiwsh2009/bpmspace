...
public class DAGmSearchLatticeNode<NodeType, EdgeType> extends
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.SearchLatticeNode#extend(de.parsemis.miner.Extension)
	 */
	@Override
		...
		do {
			...
			for (int i = 0; i < mapping.length; i++) {
				...
				while (edgeIt.hasNext()) {
					...
					newGraph.addEdge(
							newGraph.getNode(i),
							newGraph.getNode(mapOldToNew[actEdge.getOtherNode(
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.SearchLatticeNode#setFinalEmbeddings(java.util.Collection
	 * )
	 */
	@Override
