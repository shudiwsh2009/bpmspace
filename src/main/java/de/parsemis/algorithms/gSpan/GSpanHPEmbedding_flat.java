...
public class GSpanHPEmbedding_flat<NodeType, EdgeType>
	 ...
	 * 
	 * @see
	 * de.parsemis.gSpan.GSpanHPEmbedding#extend(de.parsemis.gSpan.GSpanExtension
	 ...
	 * 
	 * @see
	 * de.parsemis.graph.HPEmbedding#mapExtension(de.parsemis.miner.Extension)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.parsemis.gSpan.GSpanHPEmbedding#release(de.parsemis.utils.
	 * ThreadEnvironment)
	 */
