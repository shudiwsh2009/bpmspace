 ...
 * 
 *         Diese Klasse nimmt die berechneten Koordinaten entgegen, skaliert sie
 *         neu, wenn die Groesse des Fensters geaendert wird und zeichnet das
 *         Molekuel.
 * 
 * 
 * @param <NodeType>
	...
	private void drawNonColoredMolecule(final float height) {
		...
		for (int i = 1; i < mainData.size(); i++) {
			...
			case 1:
				...
				bondAndLabelDrawer.singleBond(x1_kor, y1_kor, x2_kor, y2_kor,
						d.getKindOfEnd(setCarbonLabels), d.neighborLabel,
						newLength);
				break;
			case 2:
				if (angleSizeInCycle > 0) {
				...
				break;
			case 3:
				bondAndLabelDrawer.tripleBond(x1_kor, y1_kor, x2_kor, y2_kor,
						d.getKindOfEnd(setCarbonLabels), d.neighborLabel,
						newLength);
				break;
			case 4:
