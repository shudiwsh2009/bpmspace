...
public class FragmentUtil {
	...
	static String dir = "C:\\Users\\chenhz\\Documents\\Thss SVN\\THSS JBPM\\org.drools.eclipse";
	...
	public static void excuteCmd() throws IOException, InterruptedException {
		...
		String driver = dir.substring(0, dir.indexOf(":"));
		System.out.println(driver);
		String cmd1 = dir + "\\" + "fragment.bat";
		// String cmd = "cmd /c start \""+ dir+"\\bpcd\\run.bat\"";
		// String cmd =
	...
	private static ArrayList<RuleFlowProcess> parseResult() throws IOException {
		...
		String fragmentPath = dir + "\\bpcd\\fragments";
	...
	public static void fragment(String inputFilePath, String outputFilePath) {
		...
		String folderPath = dir + "\\bpcd\\models\\tmpModel";
		...
		System.out.println("==============");
		System.out.println(outputEPCs.size());
		int count = 0;
