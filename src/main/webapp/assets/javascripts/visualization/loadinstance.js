...
function instance_activity_tree(){
	var node = $("#instanceDB_tree").dynatree("getActiveNode");
	var tree =$("#activity_tree").dynatree({
		title : "Lazy loading sample",
		fx : {
			height : "toggle",
			duration : 200
		...
		// like this:
		initAjax : {
			url : 'statisticTable/variantsCatalog',
			data : {
				logId : node.data.key
			}
		},
	...
	$("#activity_tree").dynatree("getTree").reload();
}
	...
	oTable = $('#instanceTable').dataTable(
			{
				...
				*/
				...
				"sServerMethod" : "GET",
				"aoColumns" : [ {
					"sTitle" : internationalNames["js.InstanceDBTables.instanceId"],
					"sClass" : "center"
				}, {
					"sTitle" : internationalNames["js.InstanceDBTables.instanceType"],
					"sClass" : "center"
				}, {
					"sTitle" : internationalNames["js.InstanceDBTables.instanceName"],
					"sClass" : "center"
				}, {
					"sTitle" : internationalNames["js.InstanceDBTables.instncaeCatalog"],
					"sClass" : "center"
				}, {
					"sTitle" : internationalNames["js.InstanceDBTables.createTime"],
					"sClass" : "center"
				} ],
