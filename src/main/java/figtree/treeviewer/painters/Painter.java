...
public interface Painter<T> {
	...
	/**
	 * Called when the painter is installed in a TreePane. Gives the painter a
	 * handle on the TreePane so that it get additional information.
	 * 
	 * @param treePane
	 */
	...
	/**
	 * Called to calibrate the painters for a given graphics context. This
	 * should work out the preferred width and height (perhaps for the current
	 * font).
	 * 
	 * @param g2
	 * @param item
	...
	/**
	 * Called to actually paint into the current graphics context. The painter
	 ...
	 * @param bounds
	 */
	void paint(Graphics2D g2, T item, Justification justification,
			Rectangle2D bounds);
