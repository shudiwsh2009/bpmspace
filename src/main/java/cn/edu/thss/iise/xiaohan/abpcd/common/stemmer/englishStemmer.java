...
public class englishStemmer extends
		cn.edu.thss.iise.xiaohan.abpcd.common.stemmer.SnowballStemmer {

	public englishStemmer() {
		stopWords = null;// loadStringSetFromText(mapdir + "englishST.txt");
	}
