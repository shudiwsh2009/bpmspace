...
public class AEventQueryResultCollector extends Collector {
	private int docBase;
	...
	public AEventQueryResultCollector(IndexReader reader, String eventName) {
		this.reader = reader;
	...
	public void collect(int doc) throws IOException {
		...
		String strLogID = reader.document(docNum).get(
				AEventIndexDocument.FIELDLOGID);
		if (strLogID == null) {
			return;
		}
