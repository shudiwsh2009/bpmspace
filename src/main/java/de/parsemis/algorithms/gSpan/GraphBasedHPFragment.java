...
/**
 * Represents a fragment to count (and store if wished) embeddings for graph
 * based mining.
 * 
...
public class GraphBasedHPFragment<NodeType, EdgeType> extends
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.HPFragment#release(de.parsemis.utils.ThreadEnvironment)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.general.GraphBasedHPFragment#set(de.parsemis.graph.
	 * HPGraph)
	 */
	@Override
