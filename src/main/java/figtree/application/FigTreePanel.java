...
public class FigTreePanel extends JPanel {
	...
	public FigTreePanel(JFrame frame, final ExtendedTreeViewer treeViewer,
		...
		// controlPalette.getPanel().setBorder(BorderFactory.createMatteBorder(0,
		// 0, 0, 1, Color.GRAY));
		...
		final BasicLabelPainter branchLabelPainter = new BasicLabelPainter(
		...
		controlPalette.addController(new ScaleBarPainterController(
				scaleBarPainter, treeViewer));
		...
		controlPalette.addController(new ScaleAxisPainterController(
				scaleAxisPainter, scaleGridPainter, treeViewer));
