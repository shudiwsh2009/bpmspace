	...
	private void chooserButtonActionPerformed(java.awt.event.ActionEvent evt) {
		try {
			...
			if (chooser == null) {
				 ...
				 * public void setSelectedColor(Color c) { new
				 * Throwable().printStackTrace(); super.setSelectedColor(c); } }
				 * );
				 */
				// JOptionPane.showMessageDialog(this, "Made a new chooser");
			}
			Color color = chooser.showDialog(this, colorChooserTitle,
			...
			JOptionPane.showMessageDialog(this,
					"JColorChooser Failed " + sw.toString());
			t.printStackTrace();
		}
	}
