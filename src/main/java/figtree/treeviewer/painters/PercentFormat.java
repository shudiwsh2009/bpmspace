...
/**
 * This NumberFormat converts numbers to and from percent notation. Once an
 * instance has been created, the format and parse methods may be used as
 * defined in java.text.NumberFormat.
 * 
