...
public class MultiPaneTreeViewer extends TreeViewer {
	...
	public MultiPaneTreeViewer() {
		...
		treePanePanel.setLayout(new BoxLayout(treePanePanel,
				BoxLayout.PAGE_AXIS));

		JScrollPane scrollPane = new JScrollPane(treePanePanel,
	...
	public void selectNodes(String attribute, TextSearchType searchType,
			String searchString, boolean caseSensitive) {
	}
	...
	public void selectAll() {
		// if (treePaneSelector.getSelectionMode() ==
		// TreePaneSelector.SelectionMode.TAXA) {
	...
	public void setSelectionMode(TreePaneSelector.SelectionMode selectionMode) {
		// TreePaneSelector.SelectionMode oldSelectionMode =
		// treePaneSelector.getSelectionMode();
		//
	...
	// A load of deligated method calls through to treePane (which is now hidden
	// outside the package).
