...
public class ScaleBarPainterController extends AbstractController {
	...
	public ScaleBarPainterController(final ScaleBarPainter scaleBarPainter,
		...
		scaleBarPainter.setFont(new Font(defaultFontName, defaultFontStyle,
				defaultFontSize));
		scaleBarPainter.setNumberFormat(new DecimalFormat(
				defaultNumberFormatting));
		scaleBarPainter.setScaleBarStroke(new BasicStroke(lineWidth,
		...
		final JLabel label1 = optionsPanel.addComponentWithLabel(
				"Scale Range:", scaleRangeText, true);
		...
		lineWeightSpinner.addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent changeEvent) {
				float weight = ((Double) lineWeightSpinner.getValue())
						.floatValue();
				scaleBarPainter.setScaleBarStroke(new BasicStroke(weight,
	...
	public void setSettings(Map<String, Object> settings) {
		titleCheckBox.setSelected((Boolean) settings.get(CONTROLLER_KEY + "."
				+ IS_SHOWN));
		autoScaleCheck.setSelected((Boolean) settings.get(CONTROLLER_KEY + "."
				+ AUTOMATIC_SCALE_KEY));
		scaleRangeText.setValue((Double) settings.get(CONTROLLER_KEY + "."
				+ SCALE_RANGE_KEY));
		...
		lineWeightSpinner.setValue((Double) settings.get(CONTROLLER_KEY + "."
				+ LINE_WIDTH_KEY));
	}
	...
	public void getSettings(Map<String, Object> settings) {
		...
		settings.put(CONTROLLER_KEY + "." + AUTOMATIC_SCALE_KEY,
				autoScaleCheck.isSelected());
		settings.put(CONTROLLER_KEY + "." + SCALE_RANGE_KEY,
				scaleRangeText.getValue());
		...
		settings.put(CONTROLLER_KEY + "." + LINE_WIDTH_KEY,
