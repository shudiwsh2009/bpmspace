...
/**
 * This defines necessary operations on tree required for the tree algorithms in
 * this package. Subclasses handle the particular representation of the contents
 * of the tree. This parent superclass looks after generic tree functionality
 * like ordering nodes.
 *
 * INSERT-LICENCE-INFO
 */
public abstract class TreeDefinition {
	...
	/**
	 * This is provides the string label for the node we're matching. In some
	 * cases, the value of the string may depend on properties of the node in
	 * addition to the actual node label.
	 */
	...
	/*
	 * returns a collection of nodes referred to by their original (unique)
	 * nodel label.
	 */
	public abstract Collection<String> getNodes();

	/*
	 * returns a collection of children referred to by their original (unique)
	 * nodel label.
	 */
