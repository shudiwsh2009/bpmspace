...
<div class='alert alert-info'>
    ...
    欢迎来到
    <strong>流程导入</strong>
    页面，你可以<strong>从本地选择并加载流程日志</strong>。
</div>

<div class='row-fluid' id="unconstrcued_index_panel">
    <div class='span12 box'>
        <div class='box-content box-no-padding'>
            <form name="form" action="" method="POST" enctype="multipart/form-data" class="form form-horizontal form-striped"style="margin-bottom: 0;" >
            	<div style="margin:0;padding:0;display:inline">
	            	<input name="utf8" type="hidden" value="&#x2713;" />
	            	<input name="authenticity_token" type="hidden" value="CFC7d00LWKQsSahRqsfD+e/mHLqbaVIXBvlBGe/KP+I=" />
            	</div>
                 <div class='control-group'>
                     <label class='control-label' for='inputInfo'>流程日志文件</label>
                  
                    <div class='controls'>
							<input title='选择' type='file' id="instance_file_path" name="instance_file_path" />
                ...
                <div class='form-actions' style='margin-bottom: 0;'>
                    <div class='btn btn-primary btn-large' id="input_instance_btn">
                        <i class='icon-save'></i>
                        提交
                    </div> 
                </div>
