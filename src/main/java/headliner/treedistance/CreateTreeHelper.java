...
public class CreateTreeHelper {
	 ...
	 * TreeDefinition. The format of the string is a series of edges represented
	 * as pairs of string separated by semi-colons. Each pair is comma
	 * separated. The first substring in the pair is the parent, the second is
	 * the child. The first edge parent must be the root of the tree.
	 * 
	...
	public static TreeDefinition makeTree(String treeSpec, String rootID) {
		...
		// A Tree
		Hashtable<String, ArrayList<String>> aTree = new Hashtable<String, ArrayList<String>>();
	...
	/**
	 * This adds the edge (and nodes if necessary) to the tree definition .
	 */
