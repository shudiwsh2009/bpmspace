...
public class JVerticalLabel extends JLabel {
	...
	public JVerticalLabel(String text, Icon image, int horizontalAlignment,
			boolean clockwise) {
	...
	public java.awt.Dimension getPreferredSize() {
		...
		String text = getText();
		int h = fm.stringWidth(text), descent = fm.getDescent(), ascent = fm
				.getAscent();
	...
	public void paint(java.awt.Graphics g) {
		...
		int descent = fm.getDescent(), ascent = fm.getAscent(), y = ins.top
				+ ascent;
		...
		if (clockwise) {
			trans = new java.awt.geom.AffineTransform(0, 1, -1, 0,
					-size.height, 0);
		} else {
			trans = new java.awt.geom.AffineTransform(0, -1, 1, 0, 0,
					size.height);
		}
		g2d.transform(trans);
		g2d.setPaintMode();
