...
public class JSONTreeExporter implements TreeExporter {
	...
	private void writeTrees(Collection<? extends Tree> trees)
		...
		for (Tree t : trees) {
			...
			final RootedTree rtree = isRooted ? (RootedTree) t : Utils
					.rootTheTree(t);
	...
	/**
	 * Prepare for writing a tree. If a taxa block exists and is suitable for
	 * tree, do nothing. If not, write a new taxa block.
	 * 
	 * @param tree
	 * @param node
	 * @param builder
	...
	private StringBuilder appendAttributes(Attributable item,
	...
	private StringBuilder appendAttributeValue(Object value,
