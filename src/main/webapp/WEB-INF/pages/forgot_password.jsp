...
<html>
<head>
    <title>Welcome to Process Space</title>
...
<div id='wrapper'>
    <div class='application'>
        <div class='application-content'>
            <a href="login.html"><div class='icon-heart'></div>
    ...
    <div class='controls'>
        ...
        <div class='form-wrapper'>
            ...
            <div class='text-center'>
                <hr class='hr-normal' />
                <a href="login.html"><i class='icon-chevron-left'></i>
    ...
    <div class='login-action text-center'>
        <a href="register.html"><i class='icon-user'></i>
            New to Process Space?
