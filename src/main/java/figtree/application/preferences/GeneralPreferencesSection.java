 ...
 * @version $Id: GeneralPreferencesSection.java,v 1.1 2006/09/09 15:23:33
 *          rambaut Exp $
 */
public class GeneralPreferencesSection implements PreferencesSection {
	...
	public void retrievePreferences() {
		Preferences prefs = Preferences
				.userNodeForPackage(FigTreeApplication.class);
	...
	JCheckBox generalCheck = new JCheckBox(
			"The preferences window is not implemented yet.");
}
