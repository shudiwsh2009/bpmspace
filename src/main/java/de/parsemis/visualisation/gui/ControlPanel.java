...
public class ControlPanel extends JPanel implements ActionListener,
	...
	public void actionPerformed(final ActionEvent event) {
		...
		if (command.equals(props.getProperty("sequenceOn"))) {
			cpListeners.firePropertyChange("set sequence",
					!sequenceOn.isSelected(), sequenceOn.isSelected());
		}
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see java.awt.Container#addPropertyChangeListener(java.beans.
	 * PropertyChangeListener)
	 */
	@Override
	...
	private void resetLanguageCurrentValues() {
		...
		currentFrequency.setText(String.format(
				props.getProperty("currentFrequency"), frequency));
		currentAlgo.setText(String.format(props.getProperty("currentAlgo"),
				algoNames[algo]));
		currentGraphType.setText(String.format(
				props.getProperty("currentGraphType"),
				graphTypeNames[graphType]));
