 ...
 * 
 * <p>
 * The splitting consists in choosing a pair of "promoted" data objects from the
 * children and then partition the set of children in two partitions
...
public interface SplitFunction<DATA> {
	 ...
	 * 
	 * @param dataSet
	 *            A set of data that are keys to the children of the node to be
	 *            split.
	 * @param distanceFunction
	 *            A {@linkplain DistanceFunction distance function} that can be
	 *            used to help splitting the node.
	 ...
	 */
	SplitResult<DATA> process(Set<DATA> dataSet,
