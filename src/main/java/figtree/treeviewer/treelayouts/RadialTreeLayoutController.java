 ...
 * @version $Id: RadialTreeLayoutController.java 760 2007-08-21 00:05:45Z
 *          rambaut $
 */
public class RadialTreeLayoutController extends AbstractController {
	...
	public RadialTreeLayoutController(final RadialTreeLayout treeLayout) {
		...
		// final JSlider spreadSlider = new JSlider(SwingConstants.HORIZONTAL,
		// 0, sliderMax, 0);
		// spreadSlider.setValue((int)(treeLayout.getSpread() * sliderMax /
		// 2.0));
		//
	...
	public void setSettings(Map<String, Object> settings) {
		spreadSpinner.setValue((Double) settings.get(RADIAL_LAYOUT_KEY + "."
				+ SPREAD_KEY));
	}

	public void getSettings(Map<String, Object> settings) {
		settings.put(RADIAL_LAYOUT_KEY + "." + SPREAD_KEY,
				spreadSpinner.getValue());
	}
