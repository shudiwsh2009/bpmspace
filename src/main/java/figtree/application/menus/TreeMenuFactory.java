...
/**
 * @author rambaut Date: Feb 24, 2005 Time: 5:12:11 PM
 */
	...
	public void populateMenu(JMenu menu, AbstractFrame frame) {
		...
		if (frame instanceof TreeMenuHandler) {
			...
			item.setAccelerator(KeyStroke.getKeyStroke(
					KeyEvent.VK_CLOSE_BRACKET, MenuBarFactory.MENU_MASK));
			menu.add(item);

			item = new JMenuItem(
					((TreeMenuHandler) frame).getPreviousTreeAction());
			item.setAccelerator(KeyStroke.getKeyStroke(
					KeyEvent.VK_OPEN_BRACKET, MenuBarFactory.MENU_MASK));
			menu.add(item);

			menu.addSeparator();

			item = new JMenuItem(((TreeMenuHandler) frame).getCartoonAction());
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_2,
			...
			item = new JMenuItem(
					((TreeMenuHandler) frame).getClearCollapsedAction());
			menu.add(item);
			...
			item = new JMenuItem(
					((TreeMenuHandler) frame).getMidpointRootAction());
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_M,
					MenuBarFactory.MENU_MASK));
			menu.add(item);

			item = new JMenuItem(
					((TreeMenuHandler) frame).getClearRootingAction());
			menu.add(item);
			...
			item = new JMenuItem(
					((TreeMenuHandler) frame).getIncreasingNodeOrderAction());
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_U,
					MenuBarFactory.MENU_MASK));
			menu.add(item);

			item = new JMenuItem(
					((TreeMenuHandler) frame).getDecreasingNodeOrderAction());
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_D,
					MenuBarFactory.MENU_MASK));
			menu.add(item);

			item = new JMenuItem(
					((TreeMenuHandler) frame).getClearRotationsAction());
			menu.add(item);

			menu.addSeparator();

			item = new JMenuItem(
					((TreeMenuHandler) frame).getDefineAnnotationsAction());
			menu.add(item);

			item = new JMenuItem(((TreeMenuHandler) frame).getAnnotateAction());
			item.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_QUOTE,
					MenuBarFactory.MENU_MASK));
			menu.add(item);

			// item = new
			// JMenuItem(((TreeMenuHandler)frame).getCopyAnnotationsAction());
			// menu.add(item);

			item = new JMenuItem(
					((TreeMenuHandler) frame).getAnnotateNodesFromTipsAction());
			menu.add(item);

			item = new JMenuItem(
					((TreeMenuHandler) frame).getAnnotateTipsFromNodesAction());
			menu.add(item);

			// item = new
			// JMenuItem(((TreeMenuHandler)frame).getClearAnnotationsAction());
			// menu.add(item);
			...
			item = new JMenuItem(
					((TreeMenuHandler) frame).getClearColouringAction());
			menu.add(item);
			...
			item = new JMenuItem(
					((TreeMenuHandler) frame).getClearHilightingAction());
			menu.add(item);
