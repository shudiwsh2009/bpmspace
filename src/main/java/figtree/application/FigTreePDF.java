...
public class FigTreePDF {
	...
	static public void createGraphic(int width, int height,
			String treeFileName, String graphicFileName) {
	...
	static public void main(String[] args) {
		...
		if (args2.length == 0) {
			...
			createGraphic(width, height, args2[0], (args2.length > 1 ? args2[1]
					: null));
			System.exit(0);
		} else {
			createGraphic(width, height, args2[0], (args2.length > 1 ? args2[1]
