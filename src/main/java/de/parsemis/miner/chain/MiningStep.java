...
public abstract class MiningStep<NodeType, EdgeType> implements
	...
	/**
	 * creates a new MiningStep, with will call the given <code>next</code> step
	 * during the search if necessary
	 * 
	 * @param next
	 */
	 ...
	 * with the given <code>extensions</code> this function has to call the next
	 * step, if necessary.
	 * 
	 * @param node
	 * @param extensions
