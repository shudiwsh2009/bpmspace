 ...
 */
public class MeterChartDemo extends ApplicationFrame {
	...
	private static JFreeChart createChart(ValueDataset dataset) {
		...
		plot.addInterval(new MeterInterval("Low", new Range(0.00, 20.0),
				Color.RED, new BasicStroke(2.0f), null));
		// plot.addInterval(new MeterInterval("Low", new Range(100.00, 250.0),
		// Color.GREEN, new BasicStroke(2.0f), null));

		// plot.addInterval(new MeterInterval("CS", new Range(48.68, 65.48),
		// Color.RED, new BasicStroke(2.0f), null));
	...
	public static void main(String[] args) {
		MeterChartDemo demo = new MeterChartDemo("Meter Chart Demo 2");
		demo.pack();
