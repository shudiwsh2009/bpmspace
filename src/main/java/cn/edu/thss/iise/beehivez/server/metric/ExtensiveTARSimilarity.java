...
import cn.edu.thss.iise.beehivez.server.metric.tar.ComputeSimilarity;
 ...
 * 
 */
public class ExtensiveTARSimilarity {
	public String getName() {
		return "ExtensiveTARSimilarity";
	}
	...
	public double similarity(PetriNet pn1, PetriNet pn2) {
		ComputeSimilarity compute = new ComputeSimilarity(pn1, pn2);
