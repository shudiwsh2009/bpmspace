...
public class ImageAccessory extends JPanel implements FocusListener,
	...
	public ImageAccessory(final Properties p) {
		...
		widthText = new JTextField(new LimitedDoc(textFieldSize),
				Integer.toString(defaultWidth), textFieldSize);
		...
		heightText = new JTextField(new LimitedDoc(textFieldSize),
				Integer.toString(defaultHeight), textFieldSize);
