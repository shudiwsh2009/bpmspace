...
public class FigTreeNexusImporter extends NexusImporter {
	 ...
	 */
	public void parseFigTreeBlock(Map<String, Object> settings)
	 ...
	 */
	private void readFigTreeBlock(Map<String, Object> settings)
			throws ImportException, IOException {
			...
			if (command.equalsIgnoreCase("SET")) {
				while (helper.getLastDelimiter() != ';') {
					...
					if (helper.getLastDelimiter() != '=') {
						throw new ImportException("Subcommand, " + key
								+ ", is missing a value in command, " + command
								+ ", in FIGTREE block");
					}
				...
				throw new ImportException("Unknown command, " + command
						+ ", in FIGTREE block");
			}
