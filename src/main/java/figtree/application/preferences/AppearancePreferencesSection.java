 ...
 * @version $Id: AppearancePreferencesSection.java,v 1.2 2007/08/18 09:52:24
 *          rambaut Exp $
 */
public class AppearancePreferencesSection implements PreferencesSection {
	Icon coloursToolIcon = IconUtils.getIcon(FigTreeApplication.class,
	...
	public JPanel getPanel() {
		...
		// foregroundButton = new ColorWellButton(Color.white,
		// "Choose Foreground Colour");
		// optionsPanel.addComponentWithLabel("Foreground Colour:",
		// foregroundButton);
		//
		// backgroundButton = new ColorWellButton(Color.white,
		// "Choose Background Colour");
		// optionsPanel.addComponentWithLabel("Background Colour:",
		// backgroundButton);

		selectionButton = new ColorWellButton(Color.white,
				"Choose Selection Colour");
		optionsPanel
				.addComponentWithLabel("Selection Colour:", selectionButton);
	...
	public void storePreferences() {
		...
		float branchLineWidth = ((Number) branchLineWidthSpinner.getValue())
				.floatValue();
