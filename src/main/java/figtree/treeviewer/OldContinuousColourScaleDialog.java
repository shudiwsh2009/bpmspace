...
public class OldContinuousColourScaleDialog {
	...
	public OldContinuousColourScaleDialog(final JFrame frame,
			final ColourSettings settings) {
		this.frame = frame;
		...
		fromColourButton = new ColorWellButton(settings.fromColour,
				"Choose Start Colour");
		toColourButton = new ColorWellButton(settings.toColour,
				"Choose End Colour");
		middleColourButton = new ColorWellButton(settings.middleColour,
