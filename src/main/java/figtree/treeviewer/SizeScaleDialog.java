...
public class SizeScaleDialog {
	...
	public SizeScaleDialog(final JFrame frame, final String dimensionName,
			boolean autoRange, double fromValue, double toValue,
	...
	public int showDialog() {
		...
		final JDialog dialog = optionPane.createDialog(frame, "Setup "
				+ dimensionName + " scale");
		dialog.pack();
