 ...
 *          $
 */
public class ExtendedTreeViewer extends DefaultTreeViewer implements
		StatusProvider {
	...
	public void addTree(Tree tree) {
		...
		for (String name : names) {
			if (!name.startsWith("!")) {
				AnnotationDefinition annotation = getAnnotationDefinitions()
						.get(name);
				...
				AnnotationDefinition.Type type = AnnotationDefinition
						.guessType(name, items);
	...
	public void setTaxonAnnotations(
	...
	public void showStatus() {
		fireStatusChanged(0,
				"Showing tree " + Integer.toString(getCurrentTreeIndex() + 1)
						+ " / " + getTreeCount());
	}
