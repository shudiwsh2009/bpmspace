 ...
 */
public class ScaleGridPainter extends LabelPainter<TreePane> implements
		ScalePainter {
	...
	protected void paintAxis(Graphics2D g2, Rectangle2D axisBounds) {
		...
		for (i = 0; i < n1; i++) {
			...
			if (i == (n1 - 1) && axis.getLabelLast()) { // Draw last minor tick
				...
				paintMajorLine(g2, axisBounds, axis,
	...
	protected void paintMajorLine(Graphics2D g2, Rectangle2D axisBounds,
	...
	protected void paintMinorLine(Graphics2D g2, Rectangle2D axisBounds,
			double value) {
	...
	public void setDisplayAttribute(String displayAttribute) {
		throw new UnsupportedOperationException(
				"setDisplayAttribute not implemented in ScaleGridPainter");
	}
	...
	private BasicStroke majorStroke = new BasicStroke(0.5f,
			BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL);
	private BasicStroke minorStroke = new BasicStroke(0.25f,
			BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL);
