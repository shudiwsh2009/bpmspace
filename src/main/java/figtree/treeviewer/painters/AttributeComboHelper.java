...
public class AttributeComboHelper {
	...
	public AttributeComboHelper(final JComboBox attributeComboBox,
	...
	public AttributeComboHelper(final JComboBox attributeComboBox,
			final TreeViewer treeViewer, final String defaultOption) {
	...
	public AttributeComboHelper(final JComboBox attributeComboBox,
			final TreeViewer treeViewer, final String defaultOption,
			final boolean numericalOnly, final boolean includeLineageColourings) {

		this(attributeComboBox, treeViewer, defaultOption, null, numericalOnly,
				includeLineageColourings);

	}

	public AttributeComboHelper(final JComboBox attributeComboBox,
			final TreeViewer treeViewer, final LabelPainter.PainterIntent intent) {
	...
	public AttributeComboHelper(final JComboBox attributeComboBox,
			final TreeViewer treeViewer,
			final LabelPainter.PainterIntent intent, final boolean numericalOnly) {
	...
	public static void getAttributeNames(List<String> attributeNames,
			Collection<? extends Tree> trees,
			LabelPainter.PainterIntent intent, boolean numericalOnly) {
		...
		if (numericalOnly) {
			...
			for (String nodeAttributeName : nodeAttributes) {
				...
				for (Tree tree : trees) {
					if (!ColourDecorator.isNumerical(nodeAttributeName,
							tree.getNodes())) {
						isNumerical = false;
					}
				}
	...
	private static void getAttributeNames(List<String> attributeNames,
			Collection<? extends Tree> trees,
