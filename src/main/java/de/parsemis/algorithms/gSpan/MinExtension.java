...
public class MinExtension<NodeType, EdgeType> extends
	...
	/**
	 * compares if this extensions is equal to the given <code>other</code> one
	 * 
	 * @param other
	 * @return <0; 0; or >0
	 */
	 ...
	 * 
	 * @see
	 * de.parsemis.algorithms.gSpan.GSpanEdge#release(de.parsemis.algorithms
	 * .gSpan.GThreadEnvironment)
	 */
	@Override
