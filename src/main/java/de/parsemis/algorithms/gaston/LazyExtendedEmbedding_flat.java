...
public class LazyExtendedEmbedding_flat<NodeType, EdgeType> implements
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.general.HPEmbedding#overlaps(de.parsemis.miner.general
	 * .HPEmbedding, java.util.Collection)
	 */
	 ...
	 * 
	 * @see
	 * de.parsemis.algorithms.gaston.GastonEmbedding#release(de.parsemis.miner
	 ...
	 * 
	 * @see
	 * de.parsemis.algorithms.gaston.GastonEmbedding#setFrag(de.parsemis.algorithms
	 * .gaston.GastonFragment)
	 */
