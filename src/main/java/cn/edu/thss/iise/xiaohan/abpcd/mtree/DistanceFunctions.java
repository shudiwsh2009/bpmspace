...
public final class DistanceFunctions {
	 ...
	 * function}. This method is used internally by {@link MTree} to create a
	 * cached distance function to pass to the {@linkplain SplitFunction split
	 * function}.
	 * 
	 * @param distanceFunction
	 *            The distance function to create a cached version of.
	 * @return The cached distance function.
	 */
	public static <Data> DistanceFunction<Data> cached(
			final DistanceFunction<Data> distanceFunction) {
	...
	public interface EuclideanCoordinate {
		 ...
		 * 
		 * @param index
		 *            The index of the component. Must be less than
		 *            {@link #dimensions()}.
		 */
	 ...
	 */
	public static double euclidean(EuclideanCoordinate coord1,
			EuclideanCoordinate coord2) {
	...
	public static final DistanceFunction<EuclideanCoordinate> EUCLIDEAN = new DistanceFunction<DistanceFunctions.EuclideanCoordinate>() {
		@Override
		public double calculate(EuclideanCoordinate coord1,
				EuclideanCoordinate coord2) {
	...
	/**
	 * A {@linkplain DistanceFunction distance function} object that calculates
	 * the distance between two coordinates represented by
	 * {@linkplain java.util.List lists} of {@link java.lang.Integer}s.
	 */
	public static final DistanceFunction<List<Integer>> EUCLIDEAN_INTEGER_LIST = new DistanceFunction<List<Integer>>() {
		...
		public double calculate(List<Integer> data1, List<Integer> data2) {
			...
			;
			IntegerListEuclideanCoordinate coord1 = new IntegerListEuclideanCoordinate(
					data1);
			IntegerListEuclideanCoordinate coord2 = new IntegerListEuclideanCoordinate(
					data2);
			return DistanceFunctions.euclidean(coord1, coord2);
		}
	};
	 ...
	 * A {@linkplain DistanceFunction distance function} object that calculates
	 * the distance between two coordinates represented by
	 * {@linkplain java.util.List lists} of {@link java.lang.Double}s.
	 */
	public static final DistanceFunction<List<Double>> EUCLIDEAN_DOUBLE_LIST = new DistanceFunction<List<Double>>() {
		...
		public double calculate(List<Double> data1, List<Double> data2) {
			...
			;
			DoubleListEuclideanCoordinate coord1 = new DoubleListEuclideanCoordinate(
					data1);
			DoubleListEuclideanCoordinate coord2 = new DoubleListEuclideanCoordinate(
					data2);
			return DistanceFunctions.euclidean(coord1, coord2);
		}
	};
