...
package cn.edu.thss.iise.beehivez.server.file;
...
public class BufferFile {
	...
	long seekStart = 0;
	// byte[] header;
	public static final byte[] HEADERPREFIX = { 98, 112, 78, 98, 102 };
	...
	private BufferFile(java.io.RandomAccessFile fromfile, int buffersize,
	...
	void readHeader() throws Exception {
		...
		index++;
		// read buffersize
		this.buffersize = RetrieveInt(header, index);
		this.sanityCheck();
		// this.header = header;
	}

	private byte[] makeHeader() throws Exception {
		...
		StoreInt(this.buffersize, result, HEADERPREFIX.length + 1);
		return result;
	}

	private static void copyBytesTo(byte[] fromArray, byte[] toArray,
	...
	public static void StoreInt(int TheInt, byte[] ToArray, int atIndex)
			throws Exception {
	...
	public static void StoreShort(short TheShort, byte[] ToArray, int atIndex)
			throws Exception {
	...
	public static int RetrieveInt(byte[] ToArray, int atIndex) throws Exception {
	...
	public static void StoreLong(long TheLong, byte[] ToArray, int atIndex)
			throws Exception {
...
/*
 * public class BufferFileException extends ApplicationException { public
 * BufferFileException(string message) // : base(message) { super(message); } }
 */
