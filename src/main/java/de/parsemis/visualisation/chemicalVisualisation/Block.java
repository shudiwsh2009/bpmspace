...
public class Block implements DrawingUnit {
	 ...
	 * 
	 * @see
	 * de.parsemis.visualisation.chemicalVisualisation.DrawingUnit#getGroups()
	 */
	...
	public HashMap<Integer, ArrayList<Integer>> getNeighborsNotInThisBlock() {
		...
		for (int i = 0; i < blockSize; i++) {
			...
			helper.addAll(nodes);
			regularInteriorAngles.put(cycleIndex,
					new Double(cycle.getInteriorAngle()));
		}
	 ...
	 * 
	 * @see
	 * de.parsemis.visualisation.chemicalVisualisation.DrawingUnit#initGroups()
	 */
