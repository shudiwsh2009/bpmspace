...
public class GastonFragment<NodeType, EdgeType> extends
	 ...
	 * (non-Javadoc)
	 * 
	 * @see de.parsemis.miner.general.HPFragment#add(de.parsemis.miner.general.
	 * DataBaseGraph)
	 */
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.general.HPFragment#getMaximalNonOverlappingSubSet()
	 */
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.general.HPFragment#release(de.parsemis.miner.environment
	 * .ThreadEnvironment)
	 */
