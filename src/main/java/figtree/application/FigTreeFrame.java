...
public class FigTreeFrame extends DocumentFrame implements
		FigTreeFileMenuHandler, TreeMenuHandler {
	...
	public void initializeComponents() {
		...
		Icon rerootToolIcon = IconUtils.getIcon(this.getClass(),
				"images/rerootTool.png");
		Icon rotateToolIcon = IconUtils.getIcon(this.getClass(),
				"images/rotateTool.png");
		Icon cartoonNodeToolIcon = IconUtils.getIcon(this.getClass(),
				"images/cartoonNodeTool.png");
		Icon collapseNodeToolIcon = IconUtils.getIcon(this.getClass(),
				"images/collapseNodeTool.png");
		Icon hilightToolIcon = IconUtils.getIcon(this.getClass(),
				"images/hilightTool.png");
		Icon annotationToolIcon = IconUtils.getIcon(this.getClass(),
				"images/annotationTool.png");
		Icon findToolIcon = IconUtils.getIcon(this.getClass(),
				"images/findTool.png");
		Icon infoToolIcon = IconUtils.getIcon(this.getClass(),
				"images/infoTool.png");
		Icon statisticsToolIcon = IconUtils.getIcon(this.getClass(),
				"images/statisticsTool.png");
		Icon settingsToolIcon = IconUtils.getIcon(this.getClass(),
				"images/projectTool.png");
		Icon colourToolIcon = IconUtils.getIcon(this.getClass(),
				"images/coloursTool.png");
		...
		final ToolbarAction cartoonToolbarAction = new ToolbarAction("Cartoon",
				CARTOON_NODE, cartoonNodeToolIcon) {
			public void actionPerformed(ActionEvent e) {
				cartoonAction.actionPerformed(e);
			}
		};

		ToolbarButton cartoonToolButton = new ToolbarButton(
				cartoonToolbarAction, true);
		cartoonToolButton.setFocusable(false);
		toolBar.addComponent(cartoonToolButton);

		final ToolbarAction collapseToolbarAction = new ToolbarAction(
				"Collapse", COLLAPSE_NODE, collapseNodeToolIcon) {
			public void actionPerformed(ActionEvent e) {
				collapseAction.actionPerformed(e);
			}
		};
		ToolbarButton collapseToolButton = new ToolbarButton(
				collapseToolbarAction, true);
		collapseToolButton.setFocusable(false);
		toolBar.addComponent(collapseToolButton);

		final ToolbarAction rerootToolbarAction = new ToolbarAction("Reroot",
				ROOT_ON_BRANCH, rerootToolIcon) {
			public void actionPerformed(ActionEvent e) {
				rerootAction.actionPerformed(e);
			}
		};
		ToolbarButton rerootToolButton = new ToolbarButton(rerootToolbarAction,
				true);
		rerootToolButton.setFocusable(false);
		toolBar.addComponent(rerootToolButton);

		final ToolbarAction rotateToolbarAction = new ToolbarAction("Rotate",
				ROTATE_NODE, rotateToolIcon) {
			public void actionPerformed(ActionEvent e) {
				rotateAction.actionPerformed(e);
			}
		};
		ToolbarButton rotateToolButton = new ToolbarButton(rotateToolbarAction,
				true);
		rotateToolButton.setFocusable(false);
		toolBar.addComponent(rotateToolButton);

		final ToolbarAction annotateToolbarAction = new ToolbarAction(
				"Annotate", ANNOTATE, annotationToolIcon) {
			public void actionPerformed(ActionEvent e) {
				annotateAction.actionPerformed(e);
			}
		};
		ToolbarButton annotationToolButton = new ToolbarButton(
				annotateToolbarAction, true);
		annotationToolButton.setFocusable(false);
		toolBar.addComponent(annotationToolButton);

		final ToolbarAction colourToolbarAction = new ToolbarAction("Colour",
				COLOUR, colourToolIcon) {
			public void actionPerformed(ActionEvent e) {
				colourAction.actionPerformed(e);
			}
		};
		ToolbarButton colourToolButton = new ToolbarButton(colourToolbarAction,
				true);
		colourToolButton.setFocusable(false);
		toolBar.addComponent(colourToolButton);

		final ToolbarAction hilightToolbarAction = new ToolbarAction("Hilight",
				HILIGHT, hilightToolIcon) {
			public void actionPerformed(ActionEvent e) {
				hilightAction.actionPerformed(e);
			}
		};
		ToolbarButton hilightToolButton = new ToolbarButton(
				hilightToolbarAction, true);
		hilightToolButton.setFocusable(false);
		toolBar.addComponent(hilightToolButton);

		toolBar.addSeparator();

		final ToolbarAction findToolbarAction = new ToolbarAction("Find",
				"Find Taxa...", findToolIcon) {
			public void actionPerformed(ActionEvent e) {
		...
		// final ToolbarAction infoToolbarAction = new ToolbarAction("Get Info",
		// "Get Info...", infoToolIcon) {
		// public void actionPerformed(ActionEvent e){
		...
		toggle1.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) {
					treeViewer
							.setSelectionMode(TreePaneSelector.SelectionMode.NODE);
				}
			}
		});
		toggle2.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) {
					treeViewer
							.setSelectionMode(TreePaneSelector.SelectionMode.CLADE);
				}
			}
		});
		toggle3.addItemListener(new ItemListener() {
			public void itemStateChanged(ItemEvent e) {
				if (e.getStateChange() == ItemEvent.SELECTED) {
					treeViewer
							.setSelectionMode(TreePaneSelector.SelectionMode.TAXA);
				}
			}
		});
		...
		box1.add(toggle2);
		box1.add(toggle3);
		toolBar.addComponent(new GenericToolbarItem("Selection Mode",
				"What aspect of the tree is selected when it is clicked", box1));

		toolBar.addFlexibleSpace();

		final ToolbarAction prevTreeToolbarAction = new ToolbarAction(null,
				"Previous Tree...", prevIcon) {
			public void actionPerformed(ActionEvent e) {
				if (treeViewer.isRootingOn()
						&& treeViewer.getRootingType() == TreePane.RootingType.USER_ROOTING) {
					JOptionPane
							.showMessageDialog(
									FigTreeFrame.this,
									"Cannot switch trees when user rooting option is on.\n"
		...
		final ToolbarAction nextTreeToolbarAction = new ToolbarAction(null,
				"Next Tree...", nextIcon) {
			public void actionPerformed(ActionEvent e) {
				if (treeViewer.isRootingOn()
						&& treeViewer.getRootingType() == TreePane.RootingType.USER_ROOTING) {
		...
		nextTreeToolbarAction
				.setEnabled(treeViewer.getCurrentTreeIndex() < treeViewer
						.getTreeCount() - 1);
		...
		toolBar.addComponent(new GenericToolbarItem("Prev/Next",
				"Navigate through the trees", box2));

		TreeViewerListener l = new TreeViewerListener() {
			public void treeChanged() {
				boolean nextTreeEnabled = treeViewer.getCurrentTreeIndex() < treeViewer
						.getTreeCount() - 1;
		...
		boolean first = true;
		for (TreeViewer.TextSearchType searchType : TreeViewer.TextSearchType
				.values()) {
		...
		filterPanel.addSearchPanelListener(new SearchPanelListener() {
			 ...
			 * typed a search string into the text field. If the
			 * continuousUpdate flag is true then this method is called when the
			...
			public void searchStarted(String searchString) {
				...
				for (TreeViewer.TextSearchType searchType : TreeViewer.TextSearchType
					...
					if (searchType.toString().equals(value)) {
						treeViewer.selectTaxa("!name", searchType,
								searchString, false);
					}
				}
			}
		...
		statusBar.setBorder(BorderFactory.createCompoundBorder(BorderFactory
				.createCompoundBorder(BorderFactory.createMatteBorder(1, 0, 0,
						0, Color.darkGray), BorderFactory.createMatteBorder(1,
						0, 0, 0, Color.lightGray)), BorderFactory
				.createEmptyBorder(2, 12, 2, 12)));
	...
	private void defineAnnotations() {
		...
		Collection<AnnotationDefinition> definitions = treeViewer
				.getAnnotationDefinitions().values();
		...
		treeViewer.setAnnotationDefinitions(annotationDefinitionsDialog
				.getAnnotations());
	...
	private void hilightSelected() {
		Color color = JColorChooser
				.showDialog(this, "Select Colour", lastColor);
		if (color != null) {
	...
	private void rerootTree() {
		...
		if (nodes.size() != 1) {
			JOptionPane.showMessageDialog(this,
					...
					"Annotating Tree", JOptionPane.WARNING_MESSAGE);
			return;
		}
	...
	private void annotateSelected() {
		...
		definitions.add(new AnnotationDefinition("Name", "!name",
		...
		if (annotationDialog.showDialog(definitions, item) != JOptionPane.CANCEL_OPTION) {
			...
			List<AnnotationDefinition> defs = new ArrayList<AnnotationDefinition>(
	...
	private void copySelectedAnnotations() {
		...
		// treeViewer.setToolMode(TreePaneSelector.ToolMode.SELECT);
		//
		// List<AnnotationDefinition> definitions = new
		...
		// if (result == JOptionPane.CANCEL_OPTION || result ==
		// JOptionPane.CLOSED_OPTION) {
		// return;
		// }
		// }
		// if (annotationDialog.showDialog(definitions, item) !=
	...
	public boolean readFromString(String string) throws IOException {
		boolean isNexus = string.substring(0, 80).toUpperCase()
				.contains("#NEXUS");
	...
	/**
	 * This version loads the trees in a thread but this needs more thought in
	 * order to tie in to the JAM framework correctly
	 *
	 * protected boolean readData(final Reader reader, final boolean isNexus) {
	 * 
	 * final JFrame frame = this; Thread readThread = new Thread () { public
	 * void run() { try {
	 * 
	 ...
	 * First of all, fully populate the settings map so that // all the settings
	 * have defaults controlPalette.getSettings(settings);
	 * 
	 * if (isNexus) { FigTreeNexusImporter importer = new
	 * FigTreeNexusImporter(reader); while (importer.hasTree()) { Tree tree =
	 * importer.importNextTree(); trees.add(tree); } // Try to find a figtree
	 * block and if found, parse the settings while (true) { try {
	 * importer.findNextBlock(); if
	 * (importer.getNextBlockName().equalsIgnoreCase("FIGTREE")) {
	 * importer.parseFigTreeBlock(settings); hasSettings = true; } } catch
	 * (EOFException ex) { break; } } } else { NewickImporter importer = new
	 * NewickImporter(reader, true); while (importer.hasTree()) { Tree tree =
	 * importer.importNextTree(); trees.add(tree); } }
	 * 
	 * if (trees.size() == 0) { throw new
	 * ImportException("This file contained no trees."); }
	 * 
	 * final boolean hasSettings2 = hasSettings;
	 * 
	 * EventQueue.invokeLater ( new Runnable () { public void run () {
	 * treeViewer.setTrees(trees); controlPalette.setSettings(settings);
	 * 
	 * if (!hasSettings2) { // If there weren't settings in the file then this
	 * wasn't a TreeDraw // created document so we don't want to be able to
	 * overwrite it without // explicit action of the user... setDirty();
	 * clearFile(); } } });
	 * 
	 * } catch (final ImportException ie) { EventQueue.invokeLater ( new
	 * Runnable () { public void run () { JOptionPane.showMessageDialog(frame,
	 * "Error reading tree file: " + ie.getMessage(), "Import Error",
	 * JOptionPane.ERROR_MESSAGE); } }); } catch (final InterruptedIOException
	 * iioex) { // The cancel dialog button was pressed - do nothing } catch
	 * (final IOException ioex) { EventQueue.invokeLater ( new Runnable () {
	 * public void run () { JOptionPane.showMessageDialog(frame,
	 * "File I/O Error: " + ioex.getMessage(), "File I/O Error",
	 * JOptionPane.ERROR_MESSAGE); } }); }
	 * 
	 * } }; readThread.start();
	 * 
	...
	public final void doImport() {
		...
		FileDialog dialog = new FileDialog(this, "Import Annotations File...",
				FileDialog.LOAD);
		...
		if (dialog.getFile() != null) {
			...
			try {
				...
				String[] annotationNames = new String[annotations.keySet()
						.size()];
				DiscreteColourDecorator[] decorators = new DiscreteColourDecorator[annotations
						.keySet().size()];
				...
				for (AnnotationDefinition definition : annotations.keySet()) {
					...
					decorators[i] = new HSBDiscreteColourDecorator(
							annotationNames[i], annotation.keySet());
					i++;
				}
				treeViewer.setTipLabelPainter(new StatesPainter(
						annotationNames, decorators));
				...
				JOptionPane.showMessageDialog(this, "Unable to read file: "
						+ ioe.getMessage(), "Unable to read file",
						JOptionPane.ERROR_MESSAGE);
			}
		}
	...
	protected Map<AnnotationDefinition, Map<Taxon, Object>> importAnnotationsFromFile(
		...
		for (int i = 1; i < labels.length; i++) {
			...
			if (isBoolean) {
				ad = new AnnotationDefinition(labels[i],
	...
	private void doImportCharacters() {
		...
		FileDialog dialog = new FileDialog(this, "Import Characters File...",
				FileDialog.LOAD);
	...
	protected boolean importCharactersFromFile(File file)
		...
		try {
			...
			JOptionPane.showMessageDialog(this,
					"Error reading characters file: " + ie.getMessage(),
	...
	private void doImportColourScheme() {
		...
		FileDialog dialog = new FileDialog(this, "Import Colour Scheme...",
				FileDialog.LOAD);
	...
	protected boolean importColourSchemeFromFile(File file)
			throws FileNotFoundException, IOException {
	...
	public final void doExport() {
		...
		if (exportTreeDialog.showDialog() == JOptionPane.OK_OPTION) {
			...
			FileDialog dialog = new FileDialog(this, "Export Tree File...",
					FileDialog.SAVE);
	...
	public final void doExportGraphic() {
		...
		export.showExportDialog(this, "Export view as ...",
				treeViewer.getContentPane(), "export");
	}

	public final void doExportPDF() {
		FileDialog dialog = new FileDialog(this, "Export PDF Image...",
				FileDialog.SAVE);
		...
		if (dialog.getFile() != null) {
			...
			try {
				...
				PdfTemplate tp = cb.createTemplate((float) bounds.getWidth(),
						(float) bounds.getHeight());
				Graphics2D g2d = tp.createGraphics((float) bounds.getWidth(),
						(float) bounds.getHeight(), new DefaultFontMapper());
				treeViewer.getContentPane().print(g2d);
				g2d.dispose();
				cb.addTemplate(tp, 0, 0);
			} catch (DocumentException de) {
				JOptionPane.showMessageDialog(this, "Error writing PDF file: "
						+ de, "Export PDF Error", JOptionPane.ERROR_MESSAGE);
			} catch (FileNotFoundException e) {
				JOptionPane.showMessageDialog(this, "Error writing PDF file: "
						+ e, "Export PDF Error", JOptionPane.ERROR_MESSAGE);
			}
			document.close();
		}
	}
	...
	public void doCopy() {
		...
		try {
			writeTreeFile(writer, ExportTreeDialog.Format.NEXUS, true, false,
					false, true, true);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public void doPaste() {
		...
		if (transfer.isDataFlavorSupported(DataFlavor.stringFlavor)) {
			try {
				String clip = (String) transfer
						.getTransferData(DataFlavor.stringFlavor);
				boolean isNexus = clip
						.substring(0, Math.min(80, clip.length()))
						.toUpperCase().contains("#NEXUS");
				...
				if (trees.size() == 0) {
					throw new ImportException(
							"This clipboard contained no trees.");
				}
				...
				JOptionPane.showMessageDialog(this,
						"Error reading trees on clipboard: " + ie.getMessage(),
						"Import Error", JOptionPane.ERROR_MESSAGE);
			} catch (IOException ioe) {
				JOptionPane
						.showMessageDialog(
								this,
								"Error reading trees on clipboard: "
										+ ioe.getMessage(), "Import Error",
								JOptionPane.ERROR_MESSAGE);
			} catch (UnsupportedFlavorException e) {
				JOptionPane.showMessageDialog(this,
						"Clipboard data is not compatible", "Import Error",
						JOptionPane.ERROR_MESSAGE);
			}
		}
	}
	...
	protected void writeTreeFile(Writer writer, ExportTreeDialog.Format format,
			boolean writeAllTrees, boolean writeAsDisplayed,
			boolean writeFigTreeBlock, boolean writeAnnotations,
		...
		if (trees.size() > 0) {
			...
			case NEWICK:
				...
				break;
			case NEXUS:
				FigTreeNexusExporter nexusExporter = new FigTreeNexusExporter(
						writer, writeAnnotations);
				...
				break;
			case JSON:
				JSONTreeExporter jsonExporter = new JSONTreeExporter(writer,
						writeAnnotations);
	...
	public final void doFindAll() {
		...
		if (findPanel.isNumericSearchType()) {
			TreeViewer.NumberSearchType searchType = findPanel
					.getNumberSearchType();
			Number searchValue = findPanel.getSearchValue();
			if (target == FindPanel.Target.TAXON_LABEL) {
				throw new IllegalArgumentException(
						"Can't do numeric search on taxon labels");
				...
				throw new IllegalArgumentException(
						"Can't do numeric search on all annotations");
			} else {
				treeViewer.selectNodes(targetString, searchType, searchValue);
			}

		} else {
			TreeViewer.TextSearchType searchType = findPanel
					.getTextSearchType();
			String searchText = findPanel.getSearchText();
			boolean caseSensitive = findPanel.isCaseSensitive();

			if (target == FindPanel.Target.TAXON_LABEL) {
				treeViewer.selectTaxa("!name", searchType, searchText,
						caseSensitive);
			} else if (target == FindPanel.Target.BRANCH_LENGTH) {
				throw new IllegalArgumentException(
						"Can't do text search on branch lengths");
			} else if (target == FindPanel.Target.NODE_AGE) {
				throw new IllegalArgumentException(
						"Can't do text search on node ages");
			} else if (target == FindPanel.Target.ANY_ANNOTATION) {
				treeViewer.selectNodes(null, searchType, searchText,
						caseSensitive);
			} else {
				treeViewer.selectNodes(targetString, searchType, searchText,
						caseSensitive);
			}
		}
	}
	...
	private AbstractAction importAction = new AbstractAction(
			"Import Annotations...") {
	...
	private AbstractAction importCharactersAction = new AbstractAction(
			"Import Characters...") {
		public void actionPerformed(ActionEvent ae) {
			doImportCharacters();
		}
	...
	private AbstractAction importColourSchemeAction = new AbstractAction(
	...
	private AbstractAction exportColourSchemeAction = new AbstractAction(
	...
	private AbstractAction exportTreesAction = new AbstractAction(
			"Export Trees...") {
		public void actionPerformed(ActionEvent ae) {
			doExport();
		}
	...
	private AbstractAction exportGraphicAction = new AbstractAction(
			"Export Graphic...") {
		public void actionPerformed(ActionEvent ae) {
			doExportGraphic();
		}
	...
	private AbstractAction nextTreeAction = new AbstractAction(NEXT_TREE) {
		public void actionPerformed(ActionEvent e) {
			treeViewer.showNextTree();
		}
	};

	private AbstractAction previousTreeAction = new AbstractAction(
			PREVIOUS_TREE) {
		public void actionPerformed(ActionEvent e) {
			treeViewer.showPreviousTree();
		}
	...
	private AbstractAction clearCollapsedAction = new AbstractAction(
			CLEAR_COLLAPSED) {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction midpointRootAction = new AbstractAction(
			MIDPOINT_ROOT) {
		public void actionPerformed(ActionEvent e) {
			figTreePanel.toggleMidpointRoot();
		}
	};
	private AbstractAction clearRootingAction = new AbstractAction(
			CLEAR_ROOTING) {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction clearRotationsAction = new AbstractAction(
			CLEAR_ROTATIONS) {
		public void actionPerformed(ActionEvent e) {
			treeViewer.clearRotations();
		}
	};
	private AbstractAction increasingNodeOrderAction = new AbstractAction(
			INCREASING_NODE_ORDER) {
		public void actionPerformed(ActionEvent e) {
			figTreePanel.toggleIncreasingNodeOrder();
		}
	};
	private AbstractAction decreasingNodeOrderAction = new AbstractAction(
			DECREASING_NODE_ORDER) {
		public void actionPerformed(ActionEvent e) {
	...
	private AbstractAction copyAnnotationsAction = new AbstractAction(
			COPY_ANNOTATION_VALUES) {
		public void actionPerformed(ActionEvent ae) {
			copySelectedAnnotations();
		}
	};

	private AbstractAction annotateNodesFromTipsAction = new AbstractAction(
	...
	private AbstractAction annotateTipsFromNodesAction = new AbstractAction(
	...
	private AbstractAction clearAnnotationsAction = new AbstractAction(
			CLEAR_ANNOTATIONS) {
		public void actionPerformed(ActionEvent ae) {
	...
	private AbstractAction defineAnnotationsAction = new AbstractAction(
			DEFINE_ANNOTATIONS) {
		public void actionPerformed(ActionEvent ae) {
			defineAnnotations();
		}
	...
	private AbstractAction clearColouringAction = new AbstractAction(
			CLEAR_COLOURING) {
		public void actionPerformed(ActionEvent ae) {
	...
	private AbstractAction clearHilightingAction = new AbstractAction(
			CLEAR_HILIGHTING) {
		public void actionPerformed(ActionEvent ae) {
