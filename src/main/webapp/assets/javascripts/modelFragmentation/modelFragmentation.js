...
(function() {
	$(document).ready(function() {	 
			...
			$.ajax({
			      ...
			      success: function(data) {
			      	if(data.state == "SUCCESS"){
			      		...
			      		$("#calculateResult").html("<p><a href=\""+data.frag.replace(/\\/g, "/")+"\"><font color='#00acec' face='微软雅黑'><big>"+internationalNames["modelFragmentation.js.downloadresult"]+"<big></font></a></p>");
			      	} else {
			      		alert(data.message);
			      	}
		...
		$('#modelfileupload1').fileupload({
	    	url:'uploadfiles/modelFragmentation',
	    	autoUpload: true,
	        ...
	        formData : {
	        	...
	        	if(data.result['status']=="sucess"){
	        		...
	        		bootbox.dialog("<font color='#00acec' face='微软雅黑'><big>请上传epml文件！<big></font>", [ {
						label : "确定",
						"class" : "btn-primary"
					} ]);
	        	}
