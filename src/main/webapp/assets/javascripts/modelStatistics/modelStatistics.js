...
var folder="";
var filenames;
var checked = new Array(48);
var pageflag = "1_0_5";

var treeData = [
		{title: "已经选择的文件", isFolder: true, key: "rootfolder",id:"rootfolder",
		    children: [
...
(function() {
	$(document).ready(function() {	 
			...
			$.ajax({
			      ...
			      success: function(data) {
			      	if(data.state == "SUCCESS"){
			      		...
			      		$("#calculateResult").html("<p>下面是结果链接：</p>");
			      		$("#calculateResult").append("<p><a href=\""+data.output.replace(/\\/g, "/")+"\"><font color='#00acec' face='微软雅黑'><big>点此下载<big></font></a></p>");
			      	} else {
			      		alert(data.message);
			      	}
		...
		$('#modelfileupload1').fileupload({
	    	url:'uploadfiles/modelStatistics',
	    	autoUpload: true,
	        ...
	        formData : {
	        	...
	        	if(data.result['status']=="sucess"){
	        		...
	        		bootbox.dialog("<font color='#00acec' face='微软雅黑'><big>请上传pnml文件！<big></font>", [ {
						label : "确定",
						"class" : "btn-primary"
					} ]);
	        	}
		...
		$('#check_0_all').click(function(){
			$("[name = tuopu]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });
			
		});
		$('#check_1_all').click(function(){
			$("[name = andsplit]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });	
		});
		$('#check_2_all').click(function(){
			$("[name = andjoin]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });
		});
		$('#check_3_all').click(function(){
			$("[name = xorsplit]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });
		});
		$('#check_4_all').click(function(){
			$("[name = xorjoin]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });
		});
		$('#check_5_all').click(function(){
			$("[name = connection]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });
		});
		$('#check_6_all').click(function(){
			$("[name = structure]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });
		});
		$('#check_7_all').click(function(){
			$("[name = child]:checkbox").each(function () {
                $(this).attr("checked", !$(this).attr("checked"));
            });
		});
...
function getChecked(){
	...
	$("[name = tuopu]:checked").each(function () {
		checked[$(this).val()]=1;
    });
	$("[name = andsplit]:checked").each(function () {
		checked[$(this).val()]=1;
    });
	$("[name = andjoin]:checked").each(function () {
		checked[$(this).val()]=1;
    });
	$("[name = xorsplit]:checked").each(function () {
		checked[$(this).val()]=1;
    });
	$("[name = xorjoin]:checked").each(function () {
		checked[$(this).val()]=1;
    });
	$("[name = connection]:checked").each(function () {
		checked[$(this).val()]=1;
    });
	$("[name = structure]:checked").each(function () {
		checked[$(this).val()]=1;
    });
	$("[name = child]:checked").each(function () {
		checked[$(this).val()]=1;
    });
}
