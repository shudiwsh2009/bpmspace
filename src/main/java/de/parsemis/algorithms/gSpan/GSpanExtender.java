...
/**
 * Cntains the whole chain of mining steps to generate the children of a search
 * node.
 * 
...
public class GSpanExtender<NodeType, EdgeType> extends
	 ...
	 * 
	 * @see
	 * de.parsemis.miner.Extender#getChildren(de.parsemis.miner.SearchLatticeNode
	 * )
	 */
	public Collection<SearchLatticeNode<NodeType, EdgeType>> getChildren(
